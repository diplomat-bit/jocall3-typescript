...
export class Verification extends APIResource {
   ...
   * ```
   */
  biometricMatch(body: VerificationBiometricMatchParams, options?: RequestOptions): APIPromise<void> {
   ...
   * ```
   */
  document(body: VerificationDocumentParams, options?: RequestOptions): APIPromise<void> {
