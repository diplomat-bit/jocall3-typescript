...
[![NPM version](<https://img.shields.io/npm/v/jocall3-node.svg?label=npm%20(stable)>)](https://npmjs.org/package/jocall3-node) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/jocall3-node)
...
```ts
import Jocall3 from 'npm:jocall3-node';
